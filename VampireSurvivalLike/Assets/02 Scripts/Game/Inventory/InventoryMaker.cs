...
namespace Inventory
{
    public class InventoryMaker : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            UIManager.Instance.AddUI(new List<ObjectPoolType> { ObjectPoolType.BowIcon, ObjectPoolType.SwordIcon }, _shopParent, _shopX, _shopY, _shopWidth, _shopHeight, _shopSpacing);
